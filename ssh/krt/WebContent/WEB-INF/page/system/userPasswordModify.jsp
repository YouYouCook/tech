...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_add">
  ...
  <tr>
    ...
    <td width="81%"><input type="password" name="opassword" id="Y_str_opassword" title="输入原密码" onblur="return checkUnique('user.do?operate=checkPassword&checkpassword=' + this.value,this,'与原密码输入不一致，请重试！');"size="22" maxlength="50" /><span>*</span><font>保持和原密码一致</font>
	</td>     
  </tr>
  <tr>
    <th width="19%">新密码：</th>
...
<logic:equal name="flag"  value="true">
    ...
    {		
	     		 ...
	     		 if(checkUnique('user.do?operate=checkPassword&checkpassword=' + document.all['opassword'].value,document.all['opassword'],'与原密码输入不一致，请重试！')){  		     		   
	   		    	if(confirm("确定要修改密码吗？"))
		        	{
		         	document.userForm.action="user.do?operate=updatePasswordUser";
					userForm.submit();
		       		}
	      	}
	     }
