...
<html:form method="post" action="/storageManage.do?operate=toUpdate">
<input type="hidden" name="operate">
<input type="hidden" name="storageBO.id"  value="${storageBO.id}">
<div class="weizhi">
	<div class="weizhi_bj">修改库存信息</div>
</div>
...
<script language="JavaScript">
    function updateShqd()
    {
		        ...
		        {
		         	document.storageForm.action="storageManage.do?operate=update";
					storageForm.submit();
		        }
        	}
