...
<html:form 	method="post" action="/MedicineZbAction.do?operate=resultForCgWindowList">
...
<table border="0" cellpadding="0" cellspacing="0" class="table_list">
  ...
  <tr>
							...
							<logic:notEmpty name="reslutList">
								<logic:iterate id="item" name="reslutList" indexId="indexNo">
									<tr onmouseover="this.className='over'" onmouseout="this.className='out'"  onclick="showInfo(<bean:write name="indexNo"/>,this);">
									     ...
									     value="<bean:write name="item" property="zbId"/>"/></td>	
	...
	<div>
					...
					<ssi:page property="pageInfo"  action="/MedicineZbAction.do?operate=resultForCgWindowList"/>
	</div>
	</td>
	</tr>
    <tr>
    ...
    { 
 	...
 	function toCheck(){
  	...
  	if(checkSubmit(document.medicineZbForm)){
			...
			document.medicineZbForm.action="MedicineZbAction.do?operate=resultForCgWindowList";
