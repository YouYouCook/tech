...
<html:form method="post" action="/storageManage.do?operate=zllist">
<input type="hidden" name="operate"/>
<div class="weizhi">
<div class="weizhi_bj">库存  放行维护</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="table_list" style="width:100%;margin-top:0px;">
  ...
  <tr>
	...
	<div>
					...
					<ssi:page property="pageInfo"  action="/storageManage.do?operate=zllist"/>
	</div>
	</td>
  </tr>
</table>
...
<script language="JavaScript">
    ...
    function toUpdate()
    {
        ...
        {
        document.storageForm.action="storageManage.do?operate=zltoUpdate";
