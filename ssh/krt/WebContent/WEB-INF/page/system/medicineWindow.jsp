...
<html:form 	method="post" action="/medicineManage.do?operate=windowlist">
<div class="weizhi">
...
<table border="0" cellpadding="0" cellspacing="0" class="table_list">
  ...
  <tr>
	...
	<div>
					...
					<ssi:page property="pageInfo"  action="/medicineManage.do?operate=windowlist"/>
	</div>
	</td>
  </tr>
  <tr>
...
function  toSerch(){
document.medicineForm.action="medicineManage.do?operate=windowlist";
medicineForm.submit();
}
