...
<html:form 	method="post" action="/supplier.do?operate=list">
<div class="weizhi">
...
<table border="0" cellpadding="0" cellspacing="0" class="table_list">
  <tr>
    ...
    <th width="89%">
	<div>
	  <input name="toAdd" type="button" value="新增" onclick="toadd()" />
      <input name="toModify" type="button" value="修改" onclick="tomodify()"/>
      <input name="todel" type="button" value="删除" onclick="todelete()"/>
	</div>
	</th>
	</c:if>
  </tr>
  ...
  <tr>
	...
	<div>
					...
					<ssi:page property="pageInfo"  action="/supplier.do?operate=list"/>
	</div>
	</td>
  </tr>
</table>
       ...
       if(isRadioChecked(customerForm.selectNos))
		...
		function todelete()
		{
			 if(isRadioChecked(customerForm.selectNos))
		    {
		    	if(confirm("确定要删除吗？"))
		    	 {
					   document.customerForm.action="supplier.do?operate=toDelete";
					    document.customerForm.submit();
		    	}
		    }
		    else
