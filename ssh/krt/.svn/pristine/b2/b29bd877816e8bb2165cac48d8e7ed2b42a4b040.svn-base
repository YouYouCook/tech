...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_add">
  ...
  <tr>
    ...
    <tr>
    <th>类别：</th>
    <td><textarea name="medicineBO.leibie"  title="备注" maxlength="200"></textarea></td>
  </tr>
    <tr>
    <th>物料编码：</th>
    <td><textarea name="medicineBO.wlbm"  title="备注" maxlength="200"></textarea></td>
  </tr>
  <tr>
    <th>备注：</th>
  ...
  <tr>
    <td colspan="2">
	<div>
	<input type="button" name="Submit" value="确认并且上传图片" onclick="add()"/>
