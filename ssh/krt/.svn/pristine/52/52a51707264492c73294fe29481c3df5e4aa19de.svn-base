...
<html:form method="post" action="/shqdManage.do?operate=update">
<input type="hidden" name="operate">
<input type="hidden" name="shqbo.id"  value="${shqbo.id}">
...
<div class="weizhi">
	<div class="weizhi_bj">送货清单修改</div>
</div>
...
<tr>
 <th width="12%">品名：</th>
    <td width="20%"> <input type="text" name="shqbo.pinmin" value="${medicine.medicineName}" readonly/><input name="button" type="button" value="查询" onclick="openwinMedicine();" /></td>
     <th width="12%">供应商：</th>
    <td width="20%"> <input type="text" name="shqbo.vipsupply" value="${custom.customerAccount}" readonly/><input name="button" type="button" value="查询" onclick="openwinSupplier();" /></td>
  	</tr>
  <tr>
	     <th width="25%">发货日期：</th>
    <td width="25%">
  ...
  <tr>
    <th>运输方式：</th>
    <td><html:text property="shqbo.ysfs" styleId="N_USN_shqbo.ysfs" value="${shqbo.ysfs}"   title="运输方式" maxlength="50"></html:text><font>地址为汉字</font>	
	</td>
	 <th>联系电话：</th>
    <td><html:text property="shqbo.lxdh" styleId="N_mob_shqbo.lxdh"   value="${shqbo.lxdh}"  title="联系电话" maxlength="20"></html:text><font>手机格式为：13901234567</font>
		
	</td>
  </tr>
  <tr>
    <th>送货人：</th>
    <td><html:text property="shqbo.shr" styleId="N_USN_shqbo.shr"   value="${shqbo.shr}"  title="送货人" maxlength="30"></html:text><font>法人代表为2-15个汉字</font>
	</td>
	 <th>收货单位：</th>
    <td><html:text property="shqbo.shdw" styleId="N_USN_shqbo.shdw"   value="${shqbo.shdw}"  title="收货单位" maxlength="30"></html:text><font>联系人为2-15个汉字</font>
		
	</td>
  </tr>
  <tr>
    <th>车牌号：</th>
    <td><html:text property="shqbo.cph" styleId="N_str_shqbo.cph"   value="${shqbo.cph}"  title="手机" maxlength="20"></html:text><font>字符</font>		
	</td>
   <th>收货人：</th>
    <td><html:text property="shqbo.shouhuoren" styleId="N_USN_shqbo.shouhuoren"   value="${shqbo.shouhuoren}"  title="收货人" maxlength="30"></html:text><font>收货人2-15个汉字</font>
	</td>
  </tr>
  <tr>
    <th>规格：</th>
    <td><html:text property="shqbo.guige" styleId="N_str_shqbo.guige"  value="${shqbo.guige}"   title="规格" maxlength="20"></html:text><font>字符</font>
		
	</td>
    <th>件数：</th>
    <td><html:text property="shqbo.jianshu" styleId="N_int_shqbo.jianshu"   value="${shqbo.jianshu}"  title="件数" maxlength="20"></html:text><font>件数为数字</font>
    ...
    <tr>
    <th>来货数量：</th>
    <td><html:text property="shqbo.laihuoshuliang" styleId="N_str_shqbo.laihuoshuliang"   value="${shqbo.laihuoshuliang}"   title="规格" maxlength="20"></html:text><font></font>
		
	</td>
    <th>实收数量：</th>
    <td><html:text property="shqbo.shishoushuliang" styleId="N_str_shqbo.shishoushuliang"    value="${shqbo.shishoushuliang}"  title="件数" maxlength="20"></html:text>
		
	</td>
  </tr>
      <tr>
    <th>产地：</th>
    <td><html:text property="shqbo.chandi" styleId="N_str_shqbo.chandi"   value="${shqbo.chandi}"   title="规格" maxlength="20"></html:text><font></font>
		
	</td>
    <th>备注：</th>
    <td><html:text property="shqbo.beizhu" styleId="N_str_shqbo.beizhu"    value="${shqbo.beizhu}"  title="件数" maxlength="20"></html:text>
...
<script language="JavaScript">
    function updateShqd()
    {
		        ...
		        {
		         	document.shqdForm.action="shqdManage.do?operate=update";
					shqdForm.submit();
		        }
        	}
